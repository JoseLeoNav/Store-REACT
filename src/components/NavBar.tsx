...
export default function NavBar() {
  ...
  const numberProducts = useSelector((store) => store.products.number);
    ...
    <header className="w-full min-h-[150px] bg-[#ff3b3c] p-[20px 20px 0 20px] flex flex-col items-center">
      ...
      >
        ...
        >
          ...
          <li id="cart" className="w-[50px] h-[50px] list-none relative">
            <Link className="w-[50px] h-[50px]" to="/cart">
              ...
              />
              <div contentEditable={numberProducts} className="absolute top-0 right-0 w-[20px] h-[20px] bg-orange-500 flex justify-center items-center text-white rounded-full text-xs">
                {numberProducts}
              </div>
            </Link>
          </li>
